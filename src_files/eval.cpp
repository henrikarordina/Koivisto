...
float material_scale = 1.6999536;
...
float* _pieceValuesEarly = new float[unusedVariable] {
     77.388435,     61.322491,     5.6173291,   -0.43810466,    -9.1889648,     7.0082126,    -3.8107462,    -8.9195986,     9.3842068,     412.05609,     39.929764,     20.252523,     18.318867,     421.40887,     26.878315,     18.807085,     31.420677,     -6.165885,     10.957318,     490.97623,     92.963203,     16.431921,      50.61655,     14.170727,     9.3355103,      1309.615,     16.559311,     4.2621093,     374.92877,     252.47603,    -49.490643,     7.1708064,    -6.1517897,     6.7732892,     17.293989,    -13.084623,    0.28554076,    -32.840466,     -29.21034,    -27.773758,    -16.909359,    -57.888477,     8.7855902,     -46.83601,    -14.938293,    -5.9212365,    -141.41199,    -279.73029,    -8.2398596,    -5.4049997,     -16.23514,    -9.0800381,    -11.244631,    -10.948155,     12.742071,    -5.2416177,     1.2883188,             0,             0,             0,
};

float* _pieceValuesLate = new float[unusedVariable] {
      108.1038,     133.70927,     11.011797,     44.448792,    -7.6115451,    -4.2336907,    -16.278719,   -0.66176844,    -5.2626081,     342.74307,     78.293625,      22.47167,     19.564337,     310.53604,     9.3873625,     33.845898,     56.121597,     5.8923097,     16.995558,     633.94971,      100.8251,     32.365238,    -13.875485,      3.195977,     7.3436937,     1107.0024,     18.977964,     63.361736,    -130.89357,     41.751652,     53.557259,     2.1060045,   -0.86274499,    -26.610241,    -36.721031,     24.315414,     27.988203,    -140.87971,    -56.945824,    -16.366201,    -9.7683392,    -64.478737,     -81.12793,    -392.25592,    -7.1824131,    -78.252533,    -531.73059,    -622.56329,    -17.181129,      1.552459,    -2.3911572,    -6.7776742,    -4.0794473,    -4.2142129,    -5.5236425,    -12.881829,     18.522503,             0,             0,             0,
};
...
bb::Score Evaluator::evaluate(Board* b) {
    ...
    if (phase>0.5){
        res -= res*(phase-0.5)*(sqrts[8]-sqrts[bitCount((res>0 ? b->getPieces()[WHITE_PAWN] : b->getPieces()[BLACK_PAWN]))])/material_scale;
    }
    return res;
    // clang-format on
}
...
float* Evaluator::getPhaseValues() { return &material_scale; }
#ifdef TUNE_PST
